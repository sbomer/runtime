...
namespace Mono.Linker.Dataflow
{
		...
		>
	{
		...
		private void AnalyzeMethod (MethodIL methodBody, MarkStep parent, ref InterproceduralState interproceduralState)
		{
			try {
		...
		private bool TryControlFlowGraphScan (MethodIL methodBody, ReflectionHandler handler, ref InterproceduralState interproceduralState)
		{
